...
3. **Screenshots** of your **pipeline**, your **tables**, and the **output for
   each of the three questions** above, since we may not be able to access your
   live workspace when we review.
